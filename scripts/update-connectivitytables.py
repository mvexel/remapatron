...
appath = '/home/ubuntu/mr-lanecount/webapp'
...
pgdb = 'osm'
pgpass = 'osm'
tables = {'tnav_connectivity_errors': 'ways_no_lanes.dump', 'tnav_ways_no_lanes': 'osm_planet.dump'}
...
if (datetime.now() - datetime.fromtimestamp(t)).seconds < frequency:
